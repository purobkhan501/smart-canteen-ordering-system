...
<head>
    ...
    <title>Staff Login - UIU Smart Canteen</title>
    ...
    <div class="login-wrapper d-flex flex-column">
        ...
        <div class="container d-flex flex-grow-1 justify-content-center align-items-center">
            <div class="login-card p-5 shadow-sm text-center bg-white">
                ...
                <h3 class="fw-bold mb-1">Staff Login</h3>
                ...
                <form action="../includes/login.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-success btn-custom w-100 py-2">Login to staff</button>
                </form>

                <p class="small text-muted mb-0 mt-3">Protected access • UIU Canteen Staff</p>
            </div>
        </div>
    </div>
