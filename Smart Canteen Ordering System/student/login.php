...
<head>
    ...
    <title>Student Login - UIU Smart Canteen</title>
    ...
    <div class="login-wrapper d-flex flex-column">
        ...
        <div class="container d-flex flex-grow-1 justify-content-center align-items-center">
            <div class="login-card p-5 shadow-sm text-center bg-white">
                ...
                <p class="text-muted small mb-4">UIU Canteen Management System</p>
                ...
                <form action="../includes/login.php" method="POST">
                    ...
                    <div class="text-start mb-3">
                        ...
                        <div class="input-group border rounded-3 p-1">
                            ...
                            <input type="text" name="username" id="username" class="form-control border-0 shadow-none" placeholder="Enter username" required>
                        </div>
                    </div>
                    <div class="text-start mb-3">
                        ...
                        <div class="input-group border rounded-3 p-1">
                            ...
                            <input type="password" name="password" id="password" class="form-control border-0 shadow-none" placeholder="Enter password" required>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-success btn-custom w-100 py-2">Login to Student</button>
                </form>

                <p class="small text-muted mb-0 mt-3">Don't have an account? <a href="register.php" class="text-success text-decoration-none fw-bold">Sign up here</a></p>
                <p class="small text-muted mb-0 mt-2">Protected access • UIU Student</p>
            </div>
        </div>
    </div>
