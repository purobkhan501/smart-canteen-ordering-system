...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="snacks.php">Snacks</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            ...
            $sql = "SELECT m.* FROM menu_item m JOIN category c ON m.category_id = c.category_id WHERE c.name = 'Snacks' AND m.is_special = 0 AND m.is_available = 1";
