...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="./snacks.php" role="button">Snacks</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            <div class="food-card">
                <img src="../assets/images/singara.jpg" alt="Food" id="food-img">
            ...
            <div class="food-card">
                <img src="../assets/images/jilapi.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Jilapi</h4>
                    <div class="price-row">
                        <span>৳10</span>
            ...
            <div class="food-card">
                <img src="../assets/images/puri.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Dal Puri</h4>
                    <div class="price-row">
                        <span>৳10</span>
            ...
            <div class="food-card">
                <img src="../assets/images/cake.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Cake</h4>
                    <div class="price-row">
                        <span>৳40</span>
