...
<body>
    <div class="header">
        ...
        <div class="header-right"> 
            ...
            <button type="button" class="cart-icon btn btn-light">
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="./drinks.php" role="button">Drinks</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            <div class="food-card">
                <img src="../assets/images/water.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Water</h4>
                    <div class="price-row">
                        <span>৳20</span>
                        <a class="plus-button btn btn-light text-center" href="#" role="button">+</a>
                    </div>
                </div>
            </div>

            <div class="food-card">
                <img src="../assets/images/mojo.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Mojo</h4>
                    <div class="price-row">
                        <span>৳20</span>
                        <a class="plus-button btn btn-light" href="#" role="button">+</a>
                    </div>
                </div>
            </div>

            <div class="food-card">
                <img src="../assets/images/7up.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>7 Up</h4>
                    <div class="price-row">
                        <span>৳20</span>
            ...
            <div class="food-card">
                <img src="../assets/images/fanta.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Fanta</h4>
                    <div class="price-row">
                        <span>৳20</span>
            ...
            <div class="food-card">
                <img src="../assets/images/tea.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Tea</h4>
                    <div class="price-row">
                        <span>৳10</span>
            ...
            <div class="food-card">
                <img src="../assets/images/lemon-tea.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Lemon Tea</h4>
                    <div class="price-row">
                        <span>৳10</span>
            ...
            <div class="food-card">
                <img src="../assets/images/coffee.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Coffee</h4>
                    <div class="price-row">
                        <span>৳25</span>
            ...
            <div class="food-card">
                <img src="../assets/images/black-coffee.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Black Coffee</h4>
                    <div class="price-row">
                        <span>৳25</span>
