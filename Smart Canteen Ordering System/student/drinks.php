...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="drinks.php">Drinks</a>
    ...
    <div class="workflow container-fluid">
        <!-- The special pre-order card section has been removed -->
        
        <div class="food-grid">
            <?php
            // Exclude special items (is_special = 0) and only show available items
            $sql = "SELECT m.* FROM menu_item m JOIN category c ON m.category_id = c.category_id WHERE c.name = 'Drinks' AND m.is_special = 0 AND m.is_available = 1";
