...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="./fast_food.php" role="button">Fast Food</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            <div class="food-card">
                <img src="../assets/images/burger.jpg" alt="Food" id="food-img">
            ...
            <div class="food-card">
                <img src="../assets/images/chicken-roll.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Chicken Roll</h4>
                    <div class="price-row">
                        <span>৳35</span>
            ...
            <div class="food-card">
                <img src="../assets/images/noodles.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Noodles</h4>
                    <div class="price-row">
                        <span>৳35</span>
            ...
            <div class="food-card">
                <img src="../assets/images/shawarma.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Shawarma</h4>
                    <div class="price-row">
                        <span>৳80</span>
            ...
            <div class="food-card">
                <img src="../assets/images/sandwich.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Sandwich</h4>
                    <div class="price-row">
                        <span>৳45</span>
            ...
            <div class="food-card">
                <img src="../assets/images/pizza.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Pizza Slice</h4>
                    <div class="price-row">
                        <span>৳50</span>
            ...
            <div class="food-card">
                <img src="../assets/images/hot-dog.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Hot Dog</h4>
                    <div class="price-row">
                        <span>৳60</span>
