...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="./rice.php" role="button">Rice</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            <div class="food-card">
                <img src="../assets/images/fried-rice.jpg" alt="Food" id="food-img">
            ...
            <div class="food-card">
                <img src="../assets/images/rice-chicken.jpg" alt="Food" id="food-img">
                <div class="food-details">
            ...
            <div class="food-card">
                <img src="../assets/images/chicken-khichuri.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Chicken Khichuri</h4>
                    <div class="price-row">
                        <span>৳75</span>
                        <a class="plus-button btn btn-light" href="#" role="button">+</a>
                    </div>
            ...
            <div class="food-card">
                <img src="../assets/images/dim-khichuri.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Dim Khichuri</h4>
                    <div class="price-row">
                        <span>৳60</span>
