...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="rice.php">Rice</a>
    ...
    <div class="workflow container-fluid">
        <div class="food-grid">
            <?php
            // Fixed category name: 'Rice' (was 'Lunch')
            $sql = "SELECT m.* FROM menu_item m JOIN category c ON m.category_id = c.category_id WHERE c.name = 'Rice'";
