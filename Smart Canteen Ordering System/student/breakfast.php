...
<body>
    ...
    <div class="catagories">
        ...
        <a class="cat-button btn btn-light nav-link active" href="./breakfast.php" role="button">Breakfast</a>
    ...
    <div class="workflow container-fluid">
        ...
        <div class="food-grid">
            <div class="food-card">
                <img src="../assets/images/parata-dalvaji.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Parata with Dal-Vaji</h4>
                    <div class="price-row">
                        <span>৳40</span>
            ...
            <div class="food-card">
                <img src="../assets/images/egg-fry.jpg" alt="Food" id="food-img">
                <div class="food-details">
                    <h4>Egg Fry</h4>
                    <div class="price-row">
                        <span>৳40</span>
