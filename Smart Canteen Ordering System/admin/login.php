...
<head>
    ...
    <title>Admin Login - UIU Smart Canteen</title>
        ...
        <div class="container d-flex flex-grow-1 justify-content-center align-items-center">
            <div class="login-card p-5 shadow-sm text-center bg-white">
                ...
                <form action="../includes/login.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-success btn-custom w-100 py-2">Login to Admin Panel</button>
                </form>

                <p class="small text-muted mb-0 mt-3">Protected access • UIU Canteen Admin</p>
            </div>
        </div>
    </div>
